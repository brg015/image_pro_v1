function [JetsMagnitude, JetsPhase, GridPosition] = GWTWgrid_Simple_bg(Im,ComplexOrSimple,GridSize,Sigma)
...
for LevelL = 0:nScale-1
    ...
    if (LevelL==1 || LevelL==2 || LevelL==3) continue; end
